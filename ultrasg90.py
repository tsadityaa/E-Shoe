...
class FSRThread(threading.Thread):
    ...
    def should_trigger(self, value):
        ...
        c = 0
        d = 1000000  # Remember to specify the c and d values in the class
        if c < value < d:
            return True
        else:
            return False
...
class neo6m(threading.Thread):
    ...
    def send_message(self):
        ...
        message = f"emergency!last recorded co-ordinates are{self.al[2]},address {self.get_address(self.al[2])}"
